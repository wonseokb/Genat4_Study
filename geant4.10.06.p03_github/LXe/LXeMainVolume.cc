                 ...
                 "housing",pMotherLogical,pMany,pCopyNo),fConstructor(c)
{
  ...
  if(fSphereOn) new G4PVPlacement(0,G4ThreeVector(5.*cm,5.*cm,5.*cm), fSphere_log,"sphere",fScint_log,false,0);
...
void LXeMainVolume::SurfaceProperties(){
  ...
  G4OpticalSurface* OpSphereSurface = new G4OpticalSurface("SphereSurface",unified,polished,dielectric_metal);
